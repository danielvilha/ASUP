package com.danielvilha.asup.context.personal.eventlistener;
...
public class OpenPersonalFragmentEventListener extends AbstractEventListener<VoidEventData> {

    private BaseEventData<VoidEventData> eventData;

    @Override
    public boolean match(BaseEventData<VoidEventData> eventData) {
        if (EventsEnum.OPEN_PERSONAL_FRAGMENT.equals(eventData.getEvent())) {
