package com.danielvilha.asup.context.personal.helper;
...
public class PersonalViewHelper implements IViewHelper {
    ...
    public PersonalViewHelper(PersonalFragment fragment) {
    ...
    public void findViewsById() {
        ...
        content.setBackgroundColor(Color.parseColor("#4D3C5EB4"));
