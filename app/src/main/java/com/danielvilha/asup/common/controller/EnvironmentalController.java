...
public class EnvironmentalController {
    ...
    public EnvironmentalController(RadioGroup rg1, RadioGroup rg2, RadioGroup rg3, RadioGroup rg4, RadioGroup rg5) {
        this.rg1 = rg1;
        this.rg2 = rg2;
        this.rg3 = rg3;
        this.rg4 = rg4;
    ...
    public List<Answer> getAnsers(Long quizId) {
        ...
        a2.setValue(UtilManager.calcValue(3, idx2));
        a2.setQuizId(quizId);
        ...
        a3.setValue(UtilManager.calcValue(5, idx3));
        a3.setQuizId(quizId);
        ...
        a4.setValue(UtilManager.calcValue(5, idx4));
        a4.setQuizId(quizId);
        ...
        a5.setValue(UtilManager.calcValue(2, idx5));
        a5.setQuizId(quizId);
